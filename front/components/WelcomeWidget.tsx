...
export default function WelcomeWidget({ userName }: { userName?: string }) {
    ...
    return (
        <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-violet-700 dark:from-indigo-900 dark:to-slate-900 rounded-3xl p-8 text-white shadow-xl shadow-indigo-500/20 mb-8 group">
