        ...
        <div className="flex-1 p-6 bg-slate-50/30">
          {filteredRappels.length ? (
                              ...
                              <div className="flex flex-wrap gap-2 mt-2">
                                {[1, 7, 30].map(days => (
                                  <button
                                    ...
                                    className="text-[10px] font-bold text-slate-500 hover:text-purple-600 bg-slate-50 hover:bg-purple-50 px-2 py-1 rounded-md transition-colors border border-slate-200 hover:border-purple-200"
                                  >
                                    +{days}j
                                  </button>
                                ))}
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center p-8 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
              ...
              <h4 className="text-slate-900 font-bold text-lg mb-2">À jour !</h4>
              <p className="text-slate-500 max-w-xs mx-auto mb-6">Aucun rappel en attente.</p>
              {canEdit && (
                <button
              ...
              <div className="bg-white border-2 border-dashed border-slate-200 rounded-xl p-5 hover:border-purple-300 transition-colors">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <textarea
                      placeholder="Description (optionnel)..."
                      className="flex-1 border-2 border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:border-purple-500 focus:ring-0 transition-colors resize-none"
                      rows={1}
