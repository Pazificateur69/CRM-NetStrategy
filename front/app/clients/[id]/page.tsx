...
export default function ClientDetailPage() {
  ...
  const formatEngagement = (value: number | null | undefined) => {
  ...
  const handleUpdateTodo = async () => {
    ...
    try {
      await updateTodo(editingTodoId, {
        ...
        date_echeance: todoForm.date_echeance || null,
      });
      cancelEditTodo();
      await reloadClient();
    } finally {
  ...
  return (
    <DashboardLayout>
      ...
      <div className="mt-8 space-y-10">
                          ...
                          <div className="grid md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <select
                                ...
                                onChange={(e) => setTodoForm((prev) => ({ ...prev, statut: e.target.value }))}
        ...
        {accessibleTabs
          .filter((tab) => tab.prestationTypes && activeTab === tab.id && tab.id !== 'compta')
          .map((tab) => {
