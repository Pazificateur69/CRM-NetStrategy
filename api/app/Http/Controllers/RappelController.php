...
class RappelController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $updateData = [
            ...
            'fait' => array_key_exists('fait', $validated) ? $validated['fait'] : $rappel->fait,
            'date_rappel' => $validated['date_rappel'] ?? $rappel->date_rappel,
            'ordre' => array_key_exists('ordre', $validated) ? $validated['ordre'] : $rappel->ordre,
            'pole' => $newPole,
        ];
        $rappel->update($updateData);
